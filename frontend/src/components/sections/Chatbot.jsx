    ...
    <>
      ...
      <div
        className={`fixed z-40 transition-all duration-300 ease-in-out
          bottom-0 left-0 right-0 w-full h-[90vh]
          md:bottom-6 md:left-auto md:right-6 md:w-[420px] md:h-[580px] md:rounded-2xl md:max-w-[calc(100vw-3rem)]
          ${
            isChatOpen
      ...
      >
        <div className="flex flex-col w-full h-full bg-gray-950 text-gray-100 border border-gray-800 rounded-t-2xl md:rounded-2xl overflow-hidden shadow-2xl shadow-green-900/20">
          ...
          {showScrollTop && (
            <button
              onClick={scrollToTop}
              className="absolute bottom-20 right-8 z-50 w-8 h-8 flex items-center justify-center rounded-full bg-gray-800 border border-gray-600 text-green-400 hover:bg-gray-700 hover:border-green-500 transition-all duration-200 shadow-lg cursor-none"
            >
